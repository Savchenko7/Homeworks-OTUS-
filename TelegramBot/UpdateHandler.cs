...
public class UpdateHandler : IUpdateHandler
{
    ...
    private Task OnHelp(Message message, ToDoUser user)
    {
...
");
    ...
    private Task OnReport(Message message, ToDoUser user)
    {
    ...
    private Task OnFind(Message message, ToDoUser user, string searchTerm)
    {
        ...
        {
            _botClient.SendMessage(message.Chat, "Задачи не найдены.");
        }
        return Task.CompletedTask;
    }
}